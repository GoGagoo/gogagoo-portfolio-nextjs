	...
	return (
		<footer className='footer border z-10 border-t-[#33353F] border-l-transparent border-r-transparent border-b-transparent'>
			...
			>
				...
				<span className='font-semibold text-2xl text-[#ADB7BE] scale-100 rounded-2xl bg-neutral-800 px-2 py-1 hover:text-white transition-transform duration-500 hover:scale-125'>Gagik Antonyan</span>
				<p className='text-slate-600'>{new Date().getFullYear()} ® All Right Reserved</p>
			</Link>
		</footer>
	)
}
